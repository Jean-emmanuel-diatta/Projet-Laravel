                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        @if (isset($confirmation))
                            @if($confirmation == 1)
                                <div class="alert alert-success">Epreuve ajoutée</div>
                            @else
                                <div class="alert alert-danger">Epreuve non ajoutée</div>
                            @endif
                        @endif
                        <form method="POST" action="/epreuve/persist">
                            @csrf
                            <div class="form-group">
                                <label class="form-label"for="nomEpreuve">Nom Epreuve</label>
                                <input class="form-control" type="text" name="nomEpreuve" id="nomEpreuve">
                            </div>
                            <div class="form-group">
